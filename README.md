...
## Project Overview
Campus-Connect is a web-based platform that is made to help college students discover ongoing and upcoming campus events, access all the academic resources, and communicate with different student clubs in one common application. This platform helps students stay engaged by providing relevant event recommendations, all campus announcements and updates, and available resources.
